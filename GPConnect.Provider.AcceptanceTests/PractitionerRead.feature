...
Scenario: Practitioner read successful request
	Given I search for practitioner "practitioner1" and save the first practitioner against key "practitioner1Id"
	Given I am using the default server
		And I am performing the "urn:nhs:names:services:gpconnect:fhir:rest:read:practitioner" interaction
	When I perform a practitioner read for the practitioner stored against key "practitioner1Id" against the URL "Practitioner"
