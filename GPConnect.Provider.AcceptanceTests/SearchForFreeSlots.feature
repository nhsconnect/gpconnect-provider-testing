...
#		And I add period request parameter with a start date of todays and an end date "14" days later
#	When I send a gpc.getschedule operation for the organization sotred as "<Organization>"
