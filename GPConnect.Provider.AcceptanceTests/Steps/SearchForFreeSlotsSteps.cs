...
namespace GPConnect.Provider.AcceptanceTests.Steps
{
    ...
    public class SearchForFreeSlotsSteps : BaseSteps
    {
        ...
        public SearchForFreeSlotsSteps(HttpContext httpContext, HttpSteps httpSteps, AccessRecordSteps accessRecordSteps, BundleSteps bundleSteps, OrganizationSteps organizationSteps, JwtSteps jwtSteps, HttpRequestConfigurationSteps httpRequestConfigurationSteps, IFhirResourceRepository fhirResourceRepository)
            : base(httpSteps)
        {
